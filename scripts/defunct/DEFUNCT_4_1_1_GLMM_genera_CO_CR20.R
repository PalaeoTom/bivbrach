## 4.1.1 GLMM - genera, original covariates, CR20
...
## Result: ratio 0.92666, p = 0.088, insignificant.
...
## Result: ratio 0.66504, p <2.2e-16, significant.
...
## Result: ratio 0.55096, p < 2.2e-16, significant.
...
## Result: ratio 0.55096, p < 2.2e16, significant.
...
## Result: ratio 0.58244, p < 2.2e-16, significant.
...
## Result: ratio 0.5228, p < 2.2e-16, significant
...
# Dispersion: ratio 0.92666, p = 0.088, insignificant.
# ZI: ratio 1.1743, p < 2.2e-16, significant.
# Outliers: expected 0.00497, observed 0.00927, p = 0.04, significant.
# Normality: p = 0.20319, insignificant.
# Collinearity: PTME VIF 7.26, bivalve:PTME VIF 7.61, all other VIFs below 2.5.
...
# Dispersion: ratio 0.94106, p = 0.248, insignificant.
# ZI: ratio 1.1909,  p < 2.2e-16, significant.
# Outliers: expected 0.005149, observed 0.007845, p = 0.22, insignificant.
# Normality: p = 0.63207, insignificant.
# Collinearity: All VIFs below 2.5 except for bivalve (3.46) and bivalve:PTME (3.05).
test.spatial.autocorrelation(bestModel_sqrt, raw_data)
## Expected -0.0008, observed = 0.0045, p = 0.02216, significant. However, no visible correlation from plot.
...
model5 <- glmer(brachiopod ~ bivalve * PTME + bath + reef + lith + AbsLat + (bivalve|stage), data = raw_data, family = poisson(link = "sqrt"), control = glmerControl(optimizer="bobyqa"), na.action = "na.fail")
...
# Dispersion: ratio 0.9429, p = 0.272, insignificant.
# ZI: ratio 1.1913,  p < 2.2e-16, significant.
# Outliers: expected 0.0051, observed 0.0079, p = 0.28, insignificant.
# Normality: p = 0.65978, insignificant.
# Collinearity: All VIFs below 2.
test.spatial.autocorrelation(bestModel_1, raw_data)
## Expected -0.0007837, observed = 0.0051117, p = 0.01097, significant. However, no visible correlation from plot.
