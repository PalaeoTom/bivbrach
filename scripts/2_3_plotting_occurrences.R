#### 2.3 Plotting distribution of occurrences ####
...
## Break down sources
table(genera$source)
table(species$source)

## Brach vs bivalve
length(which(genera$phylum=="Brachiopoda"))
length(which(genera$phylum=="Mollusca"))

length(which(species$phylum=="Brachiopoda"))
length(which(species$phylum=="Mollusca"))

#### Plot world map ####
## Plot generic occurrences
pdf(file = "figures/final/supplemental/brachiopod_genera_map.pdf")
...
pdf(file = "figures/final/supplemental/bivalve_genera_map.pdf")
map("world",col="lightgrey",fill = T)
...
pdf(file = "figures/final/supplemental/brachiopod_species_map.pdf")
map("world",col="lightgrey",fill = T)
...
pdf(file = "figures/final/supplemental/bivalve_species_map.pdf")
map("world",col="lightgrey",fill = T)
...
pdf(file = "figures/final/supplemental/raw_genera_richness.pdf")
...
## Plot
oldpar <- par(no.readonly = TRUE)
pdf(file = "figures/final/supplemental/raw_species_richness.pdf")
par(mar = c(6.1, 4.1, 4.1, 2.1))
