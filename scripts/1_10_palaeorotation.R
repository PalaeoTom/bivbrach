...
## Rotate
PBDB_rotated <- palaeorotate(PBDB, lng = "lng", lat = "lat", age = "midpoint", model = c("MERDITH2021", "PALEOMAP", "GOLONKA"), method = "point", uncertainty = T)
GBIF_rotated <- palaeorotate(GBIF, lng = "decimalLongitude", lat = "decimalLatitude", age = "midpoint", model = c("MERDITH2021", "PALEOMAP", "GOLONKA"), method = "point", uncertainty = T)
AMNH_rotated <- palaeorotate(AMNH, lng = "longitudeDecimal", lat = "latitudeDecimal", age = "midpoint", model = c("MERDITH2021", "PALEOMAP", "GOLONKA"), method = "point", uncertainty = T)
NMS_rotated <- palaeorotate(NMS, lng = "longitude", lat = "latitude", age = "midpoint", model = c("MERDITH2021", "PALEOMAP", "GOLONKA"), method = "point", uncertainty = T)
Peabody_rotated <- palaeorotate(Peabody, lng = "longitude", lat = "latitude", age = "midpoint", model = c("MERDITH2021", "PALEOMAP", "GOLONKA"), method = "point", uncertainty = T)
